...
Project: **kubovista**. Firebase Authentication now replaces the previous authentication runtime. Firebase verifies identity; PostgreSQL retains user profiles, bookings, payments and in-app notifications. FCM sends optional generic booking push alerts to devices registered to the authenticated account. No Firestore database is needed for this architecture.
