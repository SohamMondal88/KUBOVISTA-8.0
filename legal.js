...
export const legalPages = {
  "privacy": {
    ...
    "sections": [{"title":"Optional Firebase Analytics and notifications","paragraphs":["Analytics is off until you enable it through Analytics preferences in the footer. Your choice is stored in this browser. When enabled, Google Analytics processes device and usage information; our public page-view events omit query strings, account identifiers and booking details. You can disable future collection in the footer. This does not erase data already collected or remove existing cookies.","Firebase Cloud Messaging support is available for explicitly requested device testing. Notification permission is separate from Analytics. This version does not automatically enroll accounts in booking notifications or store device tokens in your profile. Firebase may process installation identifiers and notification tokens when notification testing is requested. You can revoke notification permission in browser settings."]},
