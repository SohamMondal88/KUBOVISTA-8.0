...
const publicFiles=new Set(['/','/index.html','/styles.css','/app.js','/account.js','/journal.js','/company.js','/explore.js','/destination-meta.js','/partner-data.js','/data.js','/legal.js']);
